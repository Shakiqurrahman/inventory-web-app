...
const GenerateItemFormPage = () => {
    ...
    return isLoading ? (
        <div className="p-4 bg-white dark:bg-stone-600 dark:text-gray-300">
            Loading...
        </div>
        ...
        <div className="p-4 bg-white dark:bg-stone-600 dark:text-gray-300">
            ...
            <select
                ...
                className="block p-2.5 border border-gray-200 dark:border-gray-500 dark:bg-stone-500 text-gray-600 dark:text-gray-300 outline-none cursor-pointer text-sm"
            >
            ...
            {selectedVariantObj && (
                <>
                    <div className="border border-dashed border-gray-300 p-3 space-y-2.5 mt-5 text-sm">
                        ...
                        <div className="flex gap-2 items-center">
                            <h1 className="shrink-0 w-1/6 text-right">
                                Price:
                            </h1>
                            <span className="border border-gray-200 p-2.5 w-full">
                    ...
                    <select
                        ...
                        className="block p-2.5 border border-gray-200 text-gray-600 dark:text-gray-300 dark:bg-stone-500 outline-none cursor-pointer mt-5 text-sm"
                    >
