...
import { useGetBankDepositListQuery } from "../../redux/features/bankDeposite/bankDepositeApi";
import {
...
import EditBankDepositeModal from "./EditBankDepositeModal";
...
const BankDeposites = () => {
    ...
    const { data: bankDeposites, meta, balance } = response || {};
    ...
    return (
        <div className="bg-white dark:bg-stone-700 p-4 rounded-lg">
                ...
                {!isLoading && (meta as IMetaInfo)?.totalPages > 1 && (
                    <section className="flex items-center justify-between pt-4 mt-4 border-t border-gray-200 ">
                        <p className="text-sm font-medium text-gray-600 dark:text-gray-300">
                            Total Bank Deposits : {(meta as IMetaInfo)?.total}
                        </p>
                        <Pagination
            ...
            {openEditModal && (
                <EditBankDepositeModal dataId={selectedDepositID} />
            )}
        </div>
    );
};
