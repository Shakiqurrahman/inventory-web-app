...
const OrderInformation = () => {
    ...
    const handleChangeDiscountAmount = (val: string) => {
        ...
        if (discountPercentage <= 0 && !existingDiscountOnItems) {
            if (parseInt(val) >= 0) {
                ...
                dispatch(
                    changeDueAmount(totalPrice - parseFloat(val) - totalPaid)
                );
    ...
    return (
        <div className="bg-white dark:bg-stone-700 mt-5 pb-10 paper-cut relative">
            <div className="p-3">
            ...
            <div className="p-3 bg-[#F1FFEC] dark:bg-stone-500 flex items-center justify-between gap-2">
                <h1 className="text-gray-600 dark:text-gray-300 text-sm sm:text-base font-medium">
                    Sub Total:
                </h1>
                <button
                    type="button"
                    className="text-blue-500 dark:text-blue-300 border-b border-blue-500 border-dashed flex items-center text-sm cursor-pointer"
                >
                    <TbCurrencyTaka />
                    {subTotal.toFixed(2)}
                </button>
            ...
            <div className="border-t border-b border-gray-300 border-dashed flex">
                <div className="w-1/2 text-center p-3 border-r border-gray-300 dark:border-gray-500 border-dashed">
                    <h1 className="text-base sm:text-lg font-medium mb-2 text-gray-600 dark:text-gray-300">
                        Total
                    </h1>
                ...
                <div className="p-3 border-b border-dashed border-gray-300">
                    ...
                    <div className="flex mt-3">
                        <input
                            ...
                            className="border border-gray-200 p-2.5 outline-none text-sm w-full placeholder:text-xs dark:text-gray-300"
                        />
                        <button
                            type="button"
            ...
            <div className="p-4">
                <div className="flex items-center gap-2 select-none mt-3">
                    <input
                        ...
                        onChange={(e) =>
                            dispatch(changeCorporateSale(e.target.checked))
                        }
                    />
                    <label
                        htmlFor="showComment"
