    ...
    return (
        <div>
            <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-5">
                <Link
                    to={"/sales-history"}
                    className="flex justify-between items-center p-1 bg-white dark:bg-stone-700 shadow-md dark:text-white"
                >
                    <div className="ml-4">
                ...
                <Link
                    to={"/customers"}
                    className="flex justify-between items-center p-1 bg-white shadow-md dark:bg-stone-700 dark:text-white"
                >
                    <div className="ml-4">
            ...
            <h1 className="text-center my-4 text-sm dark:text-gray-100">
                Welcome to Fit & Found Point of Sell, choose a common task below
                to get started!
            </h1>
            <div className="grid gap-5 sm:grid-cols-2">
                <Link
                    to={"/sales"}
                    className="p-3 flex gap-5 items-center bg-white dark:bg-stone-700 dark:text-gray-300 hover:bg-primary hover:text-white duration-200 rounded-sm"
                >
            ...
            <div className="flex flex-wrap md:flex-nowrap gap-5 mt-5">
                <div className="w-full md:w-2/3 bg-white dark:bg-stone-700 p-4">
                    <Bar {...config} />
                </div>
                <div className="w-full md:w-1/3 bg-white dark:bg-stone-700 p-4">
