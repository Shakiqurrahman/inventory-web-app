...
const SuppliersPage = () => {
  const { data, isLoading: getSupplierLoading } = useGetSupplierQuery("");
          ...
          <table className="w-full border-collapse rounded-md text-gray-700">
            ...
            <tbody>
              {getSupplierLoading ? (
                ...
                getSupplier.map((value: ISupplier, idx: number) => (
                  <tr
                    onClick={() => {
