...
const EditItemPage = () => {
    ...
    useEffect(() => {
        ...
        if (itemData && !isGettingItemData) {
            ...
            const defaultValues = {
                ...
                discountPercentage:
                    itemData?.discountPercentage?.toString() || "",
    ...
    return isGettingItemData ? (
        <div className="bg-white dark:bg-stone-700 dark:text-gray-200 p-4 sm:p-6 rounded-lg">
            Loading...
        </div>
    ) : (
        <div className="bg-white dark:bg-stone-600 p-4 sm:p-6 rounded-lg">
            ...
            >
                ...
                <div>
                    ...
                    <select
                        id="categoryId"
                        {...register("categoryId")}
                        className="border border-gray-300 dark:border-gray-500 w-full p-2 outline-none rounded-md dark:bg-stone-600"
                    >
