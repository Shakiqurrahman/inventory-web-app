          ...
          <table className="w-full border-collapse rounded-md text-gray-700">
            ...
            <tbody>
              {isLoading ? (
                ...
                itemsData?.map((item: IProductSummary, index: number) => (
                  <tr
                    key={index}
                  ...
                  >
                    ...
                    <td className="p-3">{item.totalStock || 0}</td>
                    <td className="p-3">{item.brand || "N/A"}</td>
                    <td className="flex p-3 relative">
                      ...
                      >
                        ...
                        <div
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            setOpenMenuIndex(index); // ✅ Correctly open the dropdown for this index
                          }}
                        >
                        ...
                        {openMenuIndex !== null && (
                          <DropdownMenuList
                            onclose={() => setOpenMenuIndex(null)} // ✅ Close properly
                            anchorEl={buttonRefs.current[index]}
                            open={openMenuIndex === index} // ✅ This works now
                          >
                            <Link
