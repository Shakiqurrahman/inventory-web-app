...
const AddVariantForm = () => {
    ...
    return (
        <div className="border border-gray-100 dark:border-gray-500 rounded-md">
            <h1 className="bg-[#dbdbdb] dark:bg-stone-600 rounded-md p-3 font-medium">
                Variant
            </h1>
            <div className="p-3">
                <div>
                    ...
                    <div className="flex mt-2">
                        <select
                            ...
                            className="border border-gray-300 dark:border-gray-600 w-full p-2 outline-none"
                        >
                            {!selectedAttribute && (
                                <option
                                    value="Shakil"
                ...
                {attributes?.length > 0 && (
                    <div className="flex items-center py-2 gap-4 border-b border-gray-200 dark:border-gray-400 text-sm mt-5">
                        <div className="w-[30%]">
                ...
                {attributes?.map((attr, i) => (
                    <div
                        key={i}
                        className="flex items-center py-2 gap-4 border-b border-gray-200 dark:border-gray-400 text-sm hover:bg-[#f0f0f0]  dark:hover:bg-stone-500 dark:bg-stone-600 overflow-x-auto md:overflow-visible"
                    >
                                    ...
                                    <div className="absolute top-full mt-2 left-0 bg-white z-[999] shadow max-w-[300px] border border-gray-200 flex flex-wrap gap-1 p-2">
                                        {attr.trashValues?.map((v, id) => (
                                            <button
                                                key={id}
                                                type="button"
                                                className="cursor-pointer p-2 bg-gray-200 dark:bg-stone-600"
                                                onClick={() =>
                ...
                {variations.length > 0 && (
                    <div className="mt-5 overflow-x-auto md:overflow-visible">
                        <table className="w-full border-collapse rounded-md text-gray-700 dark:text-gray-200">
                            <thead>
                                <tr className="bg-gray-200 dark:bg-stone-600 dark:text-gray-100 text-left *:font-semibold text-sm">
                                    <th className="p-3">
                                        Name{" "}
